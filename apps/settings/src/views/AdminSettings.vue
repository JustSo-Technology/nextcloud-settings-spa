...
import { mdiAlertCircle, mdiLock } from '@mdi/js'
...
const section = computed(() => (route.params.section as string) || 'server')
...
async function loadSection() {
	await settingsStore.loadSectionContent('admin', section.value)
}
